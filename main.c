...
#define BATTERY_LEVEL_MEAS_INTERVAL       APP_TIMER_TICKS(1000, APP_TIMER_PRESCALER)      /**< Battery level measurement interval (ticks). This value corresponds to 240 seconds. */
...
#define SEC_STATIC_PASSKEY "123456"
...
static void advertising_init(void)
{
    ...
    //ble_uuid_t adv_uuids[] = {{BAS_UUID_SERVICE, m_bas.uuid_type}};
